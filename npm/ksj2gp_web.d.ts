...
export class IntermediateFiles {
    free(): void;
    [Symbol.dispose](): void;
    constructor(shp: FileSystemSyncAccessHandle, dbf: FileSystemSyncAccessHandle, shx: FileSystemSyncAccessHandle);
}
...
export function convert_shp(zip_file: File, target_shp: string, intermediate_files: IntermediateFiles, output_file: FileSystemSyncAccessHandle, output_format: string, translate_colnames: boolean, translate_contents: boolean, ignore_translation_errors: boolean): void;
